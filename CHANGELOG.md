...
- Bump vite from 6.2.4 to 6.2.5 in the npm_and_yarn group [#61](https://github.com/haydenbleasel/orate/pull/61) ([@dependabot[bot]](https://github.com/dependabot[bot]))
...
# v1.7.3 (Thu Mar 20 2025)

#### ⚠️ Pushed to `main`

- Update azure.openai.ts ([@haydenbleasel](https://github.com/haydenbleasel))
- Resolves #49 ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix demos ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix JigsawStack doc path ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Add support for custom keys [#36](https://github.com/haydenbleasel/orate/pull/36) ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Update website [#33](https://github.com/haydenbleasel/orate/pull/33) ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.5.0 (Sat Mar 01 2025)

#### 🚀 Enhancement

- Add Cleanvoice STT and ISL [#32](https://github.com/haydenbleasel/orate/pull/32) ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Add LMNT [#31](https://github.com/haydenbleasel/orate/pull/31) ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix typo in audio type ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Remove excess comments, misc JSDoc fixes ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Add support for custom elevenlabs voices ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.0.26 (Mon Jan 27 2025)

#### ⚠️ Pushed to `main`

- Update example model (re: Assembly team) ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Create test.mp3 ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.0.21 (Mon Jan 27 2025)

#### ⚠️ Pushed to `main`

- Update cta.tsx ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix typos (thanks Assembly team) ([@haydenbleasel](https://github.com/haydenbleasel))
...
- Fix fonts ([@haydenbleasel](https://github.com/haydenbleasel))
...
# v1.0.12 (Mon Jan 27 2025)

#### ⚠️ Pushed to `main`

- Fix instances of tsx -> ts ([@haydenbleasel](https://github.com/haydenbleasel))
