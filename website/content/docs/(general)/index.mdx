...
Orate supports a wide range of providers, including [OpenAI](/docs/openai), [ElevenLabs](/docs/elevenlabs), [AssemblyAI](/docs/assemblyai) and more. You can find more information about each provider in the sidebar.

We also support the [Native Web Speech API](/docs/native) as a provider.
