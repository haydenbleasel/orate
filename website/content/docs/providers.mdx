...
<div className="grid sm:grid-cols-2 gap-4">
  <ProviderCard id="assembly" provider="AssemblyAI" supports={['transcription']} />
  <ProviderCard id="deepgram" provider="Deepgram" supports={['speech', 'transcription']} />
  <ProviderCard id="elevenlabs" provider="ElevenLabs" supports={['speech']} />
  <ProviderCard id="gladia" provider="Gladia" supports={['transcription']} />
  ...
  <ProviderCard id="murf" provider="Murf" supports={['speech']} />
  <ProviderCard id="openai" provider="OpenAI" supports={['speech', 'transcription']} />
  <ProviderCard id="rev" provider="Rev" supports={['transcription']} />
  <ProviderCard id="speechify" provider="Speechify" supports={['speech']} />
</div>
