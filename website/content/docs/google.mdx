...
The Google provider provides a `stt` function that allows you to create a speech-to-text transcription function using Google Cloud Speech-to-Text. By default, the `stt` function uses the `chirp_2` model.
