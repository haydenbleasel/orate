...
You can use Rev AI by creating a new instance of the `Rev` class:

```ts
const rev = new Rev();
```

This will use the `REV_API_KEY` environment variable. If you don't have this variable set, you can pass your API key as an argument to the constructor.

```ts
const rev = new Rev('your_api_key');
```
